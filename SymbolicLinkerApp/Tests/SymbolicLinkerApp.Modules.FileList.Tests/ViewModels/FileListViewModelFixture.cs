using Moq;
using Prism.Regions;
using SymbolicLinkerApp.Modules.FileList.ViewModels;
using SymbolicLinkerApp.Services.Interfaces;
using Xunit;

namespace SymbolicLinkerApp.Modules.ModuleName.Tests.ViewModels
{
    public class FileListViewModelFixture
    {
        ...
        public FileListViewModelFixture()
        {
        ...
        {
            var vm = new FileListViewModel(_regionManagerMock.Object, _messageServiceMock.Object);
